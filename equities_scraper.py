...
class EquityScraper:
    def __init__(self, alpha_vantage_key: str) -> None:
        ...
        base_export_path = self._get_data_export_path()
    ...
    def _scrape_income_statement(self, ticker: str, period: str):
    ...
    def get_income_statement(self, ticker: str, period: str) -> pd.DataFrame:
        ...
        try:
            ...
            # Scrape new data.
            df = self._scrape_income_statement(ticker, period)
            df.to_csv(path)
            return df

    def update_income_statement(self, ticker: str, period: str):
        if period in self.quarterly_params:
            folder = "Quarter"
        elif period in self.annual_params:
            folder = "Annual"
    ...
    def _scrape_balance_sheet(self, ticker: str, period: str):
        # Create a query
    ...
    def get_balance_sheet(self, ticker: str, period: str = "q") -> pd.DataFrame:
        ...
        try:
            ...
            # Scrape new data.
            df = self._scrape_balance_sheet(ticker, period)
            df.to_csv(path)
            return df

    def update_balance_sheet(self, ticker: str, period: str):
        if period in self.quarterly_params:
            folder = "Quarter"
        elif period in self.annual_params:
            folder = "Annual"
    ...
    def _scrape_cash_flow(self, ticker: str, period: str):
        # Create a query
    ...
    def get_cash_flow(self, ticker: str, period: str) -> pd.DataFrame:
        ...
        try:
            ...
            # Scrape new data.
            df = self._scrape_cash_flow(ticker, period)
            df.to_csv(path)
            return df

    def update_cash_flow(self, ticker: str, period: str):
        if period in self.quarterly_params:
            folder = "Quarter"
        elif period in self.annual_params:
            folder = "Annual"
...
if __name__ == "__main__":
    ...
    e = EquityScraper(alpha_vantage_key)

    df = e.get_cash_flow("AAPL", "q")
